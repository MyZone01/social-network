<template lang="">
  <div id="create-status" class="hidden lg:p-20 uk- open" uk-modal="">
    ...
    >
      ...
      <form ref="post_form" action="">
        <div class="space-y-5 mt-3 p-2">
          <textarea
            id=""
            class="w-full !text-black placeholder:!text-black !bg-white !border-transparent focus:!border-transparent focus:!ring-transparent !font-normal !text-xl   dark:!text-white dark:placeholder:!text-white dark:!bg-slate-800" name="post-content-text" rows="6" placeholder="What do you have in mind?"
          />
        </div>
        ...
        <div class="p-5 flex justify-between items-center">
          <div>
            ...
            >
              ...
              <label>
                <input
                  id="monthly1" type="radio" name="radio-status"
