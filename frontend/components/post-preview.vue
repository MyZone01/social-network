<template lang="">
  <!-- post preview modal -->
  <div id="preview_modal" class=" lg:p-20 max-lg:!items-start uk-open" uk-modal="">
    <div class="uk-modal-dialog tt relative mx-auto overflow-hidden shadow-xl rounded-lg lg:flex items-center ax-w-[86rem] w-full lg:h-[80vh]">
      ...
      <div class="lg:h-full lg:w-[calc(100vw-400px)] w-full h-96 flex justify-center items-center relative">
        <div class="relative z-10 w-full h-full">
          <img src="" alt="" class="w-full h-full object-cover absolute">
        </div>
        ...
        <div class="p-5 pb-0">
          ...
          <div class="flex gap-3 text-sm font-medium">
            ...
            <div class="-m-1">
              ...
              >
                <nav>
                  <a href="#"> <ion-icon class="text-xl shrink-0" name="bookmark-outline" />
                    Add to favorites </a>
                  <a href="#"> <ion-icon
          ...
          <p class="font-normal text-sm leading-6 mt-4">
            ...
            camera. it can be fun, challenging. It can also be a hobby, a passion. 📷
          </p>
            ...
            <div class="flex items-center gap-4 text-xs font-semibold">
              ...
              <div class="flex items-center gap-3">
                <button type="button" class="button__ico bg-slate-100 dark:bg-slate-700">
                  <ion-icon
                    class="text-lg" name="chatbubble-ellipses"
                  />
                </button>
                <span>260</span>
              </div>
        ...
        <div class="bg-white p-3 text-sm font-medium flex items-center gap-2">
          ...
          <div class="flex-1 relative overflow-hidden ">
            ...
            <div class="flex items-center gap-2 absolute bottom-0.5 right-0 m-3">
              <ion-icon class="text-xl flex text-blue-700" name="image" />
              <ion-icon class="text-xl flex text-yellow-500" name="happy" />
            </div>
          </div>
