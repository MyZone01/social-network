...
>
      <!-- timeline -->
      <div id="js-oversized" class="lg:flex 2xl:gap-16 gap-12 max-w-[1065px] mx-auto">
              ...
              <div class="py-5 uk-slider-container">
                ...
                >
                  <li class="md:pr-3" uk-scrollspy-class="uk-animation-fade">
                    ...
                    >
                      <ion-icon name="camera" class="text-2xl" />
                    </div>
                  </li>
          ...
          <div class="md:max-w-[580px] mx-auto flex-1 xl:space-y-6 space-y-3">
            ...
            <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                ...
                <div class="-mr-1">
                  ...
                  >
                    <nav>
                      ...
                      /> Mute Notification </a>
                      <a href="#"> <ion-icon class="text-xl shrink-0" name="flag-outline" />
                        Report this post </a>
                      <a href="#"> <ion-icon class="text-xl shrink-0" name="share-outline" />
                        Share your profile </a>
                      <hr>
                      <a href="#" class="text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50">
                        <ion-icon class="text-xl shrink-0" name="stop-circle-outline" />
                        Unfollow </a>
                    </nav>
                  </div>
                </div>
              ...
              >
                ...
                <div class="flex-1 relative overflow-hidden h-10">
                  <textarea
                    placeholder="Add Comment...." rows="1"
            ...
            <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
              ...
              >
                <ul class="uk-slideshow-items overflow-hidden rounded-xl" uk-lightbox="animation: fade">
                  ...
                  <li class="w-full">
                    <a
                      class="inline" href="https://getuikit.com/docs/images/photo2.jpg"
                  ...
                  <li class="w-full">
                    <a
                      class="inline" href="https://getuikit.com/docs/images/photo.jpg"
                ...
                <a class="nav-prev left-6" href="#" uk-slideshow-item="previous"> <ion-icon
                  name="chevron-back" class="text-2xl"
                /> </a>
                <a class="nav-next right-6" href="#" uk-slideshow-item="next"> <ion-icon
                  name="chevron-forward" class="text-2xl"
                /></a>
              </div>
                ...
                <div class="-mr-1">
                  ...
                  >
                    <nav>
                      ...
                      <a href="#"> <ion-icon
                        class="text-xl shrink-0 md hydrated" name="flag-outline"
                        role="img" aria-label="flag outline"
                      />
                        Report this post </a>
                      <a href="#"> <ion-icon
                        class="text-xl shrink-0 md hydrated" name="share-outline"
                      ...
                      <a href="#" class="text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50">
                        <ion-icon
                          class="text-xl shrink-0 md hydrated" name="stop-circle-outline"
            ...
            <div class="rounded-xl shadow-sm p-4 space-y-4 bg-slate-200/40 animate-pulse border1 dark:bg-dark2">
              <div class="flex gap-3">
                <div class="w-9 h-9 rounded-full bg-slate-300/20" />
                <div class="flex-1 space-y-3">
                  <div class="w-40 h-5 rounded-md bg-slate-300/20" />
                  <div class="w-24 h-4 rounded-md bg-slate-300/20" />
                </div>
                <div class="w-6 h-6 rounded-full bg-slate-300/20" />
              </div>

              <div class="w-full h-52 rounded-lg bg-slate-300/10 my-3" />

              <div class="flex gap-3">
                <div class="w-16 h-5 rounded-md bg-slate-300/20" />

                <div class="w-14 h-5 rounded-md bg-slate-300/20" />

                <div class="w-6 h-6 rounded-full bg-slate-300/20 ml-auto" />
                <div class="w-6 h-6 rounded-full bg-slate-300/20  " />
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="box p-5 px-6 border1 dark:bg-dark2 hidden">
              <div class="flex justify-between text-black dark:text-white">
                ...
                <button type="button">
                  <ion-icon name="sync-outline" class="text-xl" />
                </button>
              </div>
            ...
            <div class="box p-5 px-6 border1 dark:bg-dark2">
              ...
              <div
                class="relative capitalize font-normal text-sm mt-4 mb-2" tabindex="-1"
                uk-slider="autoplay: true;finite: true"
              >
                <div class="overflow-hidden uk-slider-container">
                  <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
