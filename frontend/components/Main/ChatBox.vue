<template>
  <div>
    ...
    >
      <svg
        class="w-6 h-6 group-aria-expanded:hidden duration-500" xmlns="http://www.w3.org/2000/svg" fill="none"
      ...
      <div class="text-base font-semibold max-sm:hidden">
        Chat
      </div>

      <svg
        class="w-6 h-6 -mr-1 hidden group-aria-expanded:block" xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <div class="relative">
        ...
        <div
          id="search__chat"
          class="bg-white p-3 absolute w-full top-11 border-b flex gap-2 hidden dark:border-slate-600 dark:bg-slate-700 z-10" uk-scrollspy="cls:uk-animation-slide-bottom-small ; repeat: true; duration:0"
        >
          <div class="relative w-full">
            ...
            >
              <ion-icon name="close-outline" class="text-xl flex" />
            </button>
          </div>
        </div>
        ...
        <!-- chat list -->
        <div id="chat__tabs" class="uk-switcher overflow-hidden rounded-xl -mt-8">
          <!-- tab list 1 -->
      ...
      <div class="w-3.5 h-3.5 absolute -bottom-2 right-5 bg-white rotate-45 dark:bg-dark3" />
    </div>
  </div>
</template>