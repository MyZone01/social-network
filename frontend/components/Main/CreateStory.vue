<template>
  <div id="create-story" class="hidden lg:p-20" uk-modal="">
    <div
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <ion-icon name="image" class="text-3xl text-teal-600" />
              <span class="text-white mt-2">Browse to Upload image </span>
            </label>

            <img
              id="createStatusImage" src="#" alt="Uploaded Image" accept="image/png, image/jpeg"
        ...
        <div class="flex justify-between items-center">
          <div class="flex items-start gap-2">
            ...
            <p class="text-sm text-gray-500 font-medium">
              Your Status will be available <br> for <span
                class="text-gray-800"
              > 24 Hours</span>
            </p>
          </div>
