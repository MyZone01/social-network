    ...
    <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
      <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
        ...
        <div class="flex items-center gap-1">
          ...
          >
            <ion-icon name="menu-outline" class="text-2xl group-aria-expanded:hidden" />
      ...
      <div class="flex-1 relative">
        <div class="max-w-[1220px] mx-auto flex items-center">
          ...
          >
            <ion-icon name="search" class="absolute left-4 top-1/2 -translate-y-1/2" />
            <input
              type="text" placeholder="Search Friends, videos .."
          ...
          >
            ...
            >
              ...
              <nav class="text-sm font-medium text-black dark:text-white">
                ...
                >
                  <ion-icon class="text-2xl" name="search-outline" /> Creative ideas
                  about Business </a>
                <a
                  href="#"
                  class="hidden relative  px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"
                >
                  <ion-icon class="text-2xl" name="search-outline" /> 8 Facts About
                  Writting </a>
              </nav>
              ...
              <div class="flex justify-end pr-2 text-sm font-medium text-red-500 hidden">
                <a href="#" class="flex hover:bg-red-50 dark:hover:bg-slate-700 p-1.5 rounded">
                  <ion-icon name="trash" class="mr-2 text-lg" /> Clear your history</a>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
            ...
            <button type="button" class="sm:p-2 p-1 rounded-full relative sm:bg-secondery dark:text-white">
              ...
              <ion-icon name="add-circle-outline" class="sm:hidden text-2xl " />
            </button>
            <div
                ...
                <div class="uk-slider-container pb-1">
                  ...
                  >
                    <li class="w-28" uk-scrollspy-class="uk-animation-fade">
                      ...
                      >
                        <ion-icon name="book" class="text-2xl drop-shadow-md" />
                    ...
                    <li class="w-28">
                      ...
                      >
                        <ion-icon name="camera" class="text-2xl drop-shadow-md" />
                        <div class="mt-1.5 text-sm font-medium">
                          Post
                        </div>
                      </div>
                    ...
                    <li class="w-28">
                      ...
                      >
                        <ion-icon name="videocam" class="text-2xl drop-shadow-md" />
                        <div class="mt-1.5 text-sm font-medium">
                          Reel
                        </div>
                      </div>
                    ...
                    <li class="w-28">
                      ...
                      >
                        <ion-icon name="location" class="text-2xl drop-shadow-md" />
                        <div class="mt-1.5 text-sm font-medium">
                          location
                        </div>
                      </div>
                    ...
                    <li class="w-28">
                      ...
                      >
                        <ion-icon name="happy" class="text-2xl  drop-shadow-md" />
                        <div class="mt-1.5 text-sm font-medium">
                          Status
                        </div>
                      </div>
            ...
            <!-- notification -->
            <button
              type="button" class="sm:p-2 p-1 rounded-full relative sm:bg-secondery dark:text-white"
            ...
            >
              ...
              <ion-icon name="notifications-outline" class="sm:hidden text-2xl" />
            </button>
            <div
              ...
              <div class="flex items-center justify-between gap-2 p-4 pb-2">
                ...
                <div class="flex gap-2.5">
                  <button type="button" class="p-1 flex rounded-full focus:bg-secondery dark:text-white">
                    <ion-icon class="text-xl" name="ellipsis-horizontal" />
                  </button>
                  <div
                    class="w-[280px] group"
            ...
            >
              ...
              <ion-icon name="chatbox-ellipses-outline" class="sm:hidden text-2xl" />
            </button>
            <div
            ...
            >
              ...
              <nav class="p-2 text-sm text-black font-normal dark:text-white">
                ...
                <a href="form-login.html">
                  ...
                  >
                    <svg
                      class="w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      <path
