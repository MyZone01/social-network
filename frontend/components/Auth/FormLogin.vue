<template>
    <div>
        ...
        <form class="space-y-7 text-sm text-black font-medium dark:text-white"
            ...
            <div>
                ...
                <div class="flex gap-2" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 400 ;repeat: true">
                    <a href="#" class="button flex-1 flex items-center gap-2 bg-primary text-white text-sm"> <i class="icon ion-social-facebook"></i> facebook </a>
                    <a href="#" class="button flex-1 flex items-center gap-2 bg-sky-600 text-white text-sm"> <ion-icon :icon="logo-twitter"></ion-icon> twitter </a>
