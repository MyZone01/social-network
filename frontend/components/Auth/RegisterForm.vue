  ...
  >
    ...
    <div class="grid grid-cols-2 gap-4 gap-y-7">
      ...
      <div class="col-span-2">
        <label id="rememberme" class="inline-flex items-center">
          <input id="accept-terms" type="checkbox" class="!rounded-md accent-red-800">
      ...
      <div class="col-span-2">
        <button class="button bg-primary text-white w-full" @click="handleRegister()">
          Get Started
        </button>
      </div>
    </div>
