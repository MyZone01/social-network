    ...
    <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
      <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
        ...
        <div class="flex items-center gap-1">
          ...
          >
            <ion-icon :icon="ioniconsMenuOutline" class="text-2xl group-aria-expanded:hidden" />
          ...
          <div id="logo">
            <NuxtLink to="/">
              ...
              <img
                src="assets/images/logo-mobile.png" class="hidden max-md:block w-20 dark:!hidden"
                alt=""
              >
              <img
                src="assets/images/logo-mobile-light.png" class="hidden dark:max-md:block w-20"
                alt=""
              >
            </NuxtLink>
          </div>
      ...
      <div class="flex-1 relative">
        <div class="max-w-[1220px] mx-auto flex items-center">
          ...
          >
            <ion-icon :icon="ioniconsSearch" class="absolute left-4 top-1/2 -translate-y-1/2" />
            <input
          ...
          >
            ...
            >
              ...
              <nav class="text-sm font-medium text-black dark:text-white">
                ...
                >
                  <ion-icon class="text-2xl" :icon="ioniconsSearchOutline" /> Creative ideas
                  about Business </a>
                <a
                  href="#"
                  class="hidden relative  px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"
                >
                  <ion-icon class="text-2xl" :icon="ioniconsSearchOutline" /> 8 Facts About
                  Writting </a>
              </nav>
              ...
              <div class="flex justify-end pr-2 text-sm font-medium text-red-500 hidden">
                <a href="#" class="flex hover:bg-red-50 dark:hover:bg-slate-700 p-1.5 rounded">
                  <ion-icon :icon="ioniconsTrash" class="mr-2 text-lg" /> Clear your history</a>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
            ...
            <button type="button" class="sm:p-2 p-1 rounded-full relative sm:bg-secondery dark:text-white">
              ...
              <ion-icon :icon="ioniconsAddCircleOutline" class="sm:hidden text-2xl " />
            </button>
            <div
            ...
            >
              ...
              <ion-icon :icon="ioniconsNotificationsOutline" class="sm:hidden text-2xl" />
            </button>
            <div
              ...
              <div class="flex items-center justify-between gap-2 p-4 pb-2">
                ...
                <div class="flex gap-2.5">
                  <button type="button" class="p-1 flex rounded-full focus:bg-secondery dark:text-white">
                    <ion-icon class="text-xl" :icon="ioniconsEllipsisHorizontal" />
                  </button>
                  <div
                    class="w-[280px] group"
            ...
            >
              ...
              <ion-icon :icon="ioniconsChatboxEllipsesOutline" class="sm:hidden text-2xl" />
            </button>
            <div
            ...
            >
              ...
              <div class="flex items-center justify-between gap-2 p-4 pb-1">
                ...
                <div class="flex gap-2.5 text-lg text-slate-900 dark:text-white">
                  <ion-icon :icon="ioniconsExpandOutline" />
