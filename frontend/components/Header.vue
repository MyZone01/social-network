    ...
    <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
      <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
        ...
        <div class="flex items-center gap-1">
          <!-- icon menu -->
          <UButton
            class="xl:hidden" square size="lg" color="gray" :ui="{ rounded: 'rounded-full' }"
      ...
      <div class="flex-1 relative">
        <div class="max-w-[1220px] mx-auto flex items-center">
          <UInput
            :ui="{ rounded: 'rounded-full' }" size="xl" color="white" placeholder="Search friends, posts, videos..."
            class="w-2/3"
          >
            <template #leading>
          ...
          <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
            ...
            <!-- create -->
            <UPopover>
              <UButton variant="solid" color="gray" :ui="{ rounded: 'rounded-full' }" square label="➕" />
              <template #panel>
                <div
                  class="bg-white p-4 rounded-lg overflow-hidden drop-shadow-xl dark:bg-gray-900 md:w-[324px] w-screen border2"
                >
                  <h3 class="font-bold text-md text-gray-900 dark:text-white mb-3">
                    Create
                  </h3>
