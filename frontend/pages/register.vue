    ...
    <div
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10"
        ...
        <div>
          ...
          <p class="text-sm text-gray-700 font-normal">If you already have an account, <a href="form-login.html"
        ...
        <UForm :validate="validate" :state="state" method="#" action="#"
          ...
          <div class="grid grid-cols-2 gap-4 gap-y-7">
            ...
            <UFormGroup label="First name" name="firstname">
              <div class="mt-2.5">
                <UInput v-model="state.firstName" id="text" name="text" type="text" placeholder="First name"
            ...
            <UFormGroup label="Last name" name="lastname">
              <div class="mt-2.5">
                <UInput v-model="state.lastName" id="text" name="text" type="text" placeholder="Last name"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">
                </UInput>
              </div>
            </UFormGroup>
            ...
            <UFormGroup label="Email adresse" name="email" class="col-span-2">
              <div class="mt-2.5">
                <UInput v-model="state.email" id="text" name="pass" type="text" placeholder="Email"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">
                </UInput>
              </div>
            </UFormGroup>
            ...
            <!-- password -->
            <UFormGroup label="Password" name="firstname">
              <div class="mt-2.5">
                <UInput id="text" name="password" type="password" placeholder="***"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">
                </UInput>
              </div>
            </UFormGroup>
            <UFormGroup label="Confirm Password" name="firstname">
              <div class="mt-2.5">
                <UInput id="text" name="password" type="password" placeholder="***"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">
                </UInput>
            ...
            <div class="col-span-0">
              <UButton type="submit" class=" button bg-primary text-white w-full">Get Started</UButton>
            </div>
