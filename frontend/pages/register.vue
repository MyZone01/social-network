  ...
  <div class="sm:flex">
    <div
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10"
        ...
        <!-- logo image-->
        <a href="#"> <img src="../template/assets/images/logo.png" class="w-28 absolute top-10 left-10 dark:hidden"
            alt=""></a>
        <a href="#"> <img src="../template/assets/images/logo-light.png"
        ...
        <div>
          ...
          <p class="text-sm text-gray-700 font-normal">
            If you already have an account, <a href="form-login.html" class="text-blue-700">Login here!</a>
          </p>
        </div>


        <!-- form -->
        <UForm :validate="validate" :state="state" method="#" action="#"
          ...
          <div class="grid grid-cols-2 gap-4 gap-y-7">
            ...
            <UFormGroup label="First name" name="firstname">
              <div class="mt-2.5">
                <UInput id="text" v-model="state.firstName" name="text" type="text" placeholder="First name"
            ...
            <UFormGroup label="Last name" name="lastname">
              <div class="mt-2.5">
                <UInput id="text" v-model="state.lastName" name="text" type="text" placeholder="Last name"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            <!-- email -->
            <UFormGroup label="Email adresse" name="email" class="col-span-2">
              <div class="mt-2.5">
                <UInput id="text" v-model="state.email" name="pass" type="text" placeholder="Email"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            <UFormGroup label="Date of birth" name="dateOfBirth" class="col-span-2">
              <div class="mt-2.5">
                <UInput id="dateOfBirth" v-model="state.dateOfBirth" type="date"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            <!-- password -->
            <UFormGroup label="Password" name="password">
              <div class="mt-2.5">
                <UInput id="text" v-model="state.password" name="password" type="password" placeholder="***"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            <UFormGroup label="Confirm Password" name="confirmPassword">
              <div class="mt-2.5">
                <UInput id="text" v-model="state.confirmPassword" name="confirmPassword" type="password" placeholder="***"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            <UFormGroup label="Nickname" name="nickname">
              <div class="mt-2.5">
                <UInput id="text" v-model="state.nickname" name="nickname" type="text" placeholder="Nickname"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            ...
            <UFormGroup label="About you" name="aboutMe" class="col-span-2">
              <div class="mt-2.5">
                <UTextarea v-model="state.aboutMe" type="text" placeholder=""
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" />
              </div>
            </UFormGroup>
            <UFormGroup label="Profile Picture" name="avatar" class="col-span-2">
              <div class="mt-2.5">
                <UInput id="avatar" type="file" accept="image/*"
                  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"
    ...
    <div class="flex-1 relative bg-primary max-md:hidden">
      <div class="relative w-full h-full" tabindex="-1" uk-slideshow="animation: slide; autoplay: true">
        <ul class="uk-slideshow-items w-full h-full">
          <li class="w-full">
            <img src="../template/assets/images/post/img-3.jpg" alt=""
            ...
            <div class="absolute bottom-0 w-full uk-tr ansition-slide-bottom-small z-10">
              <div class="max-w-xl w-full mx-auto pb-32 px-5 z-30 relative"
                ...
                <p class="!text-white text-lg mt-7 leading-8" uk-slideshow-parallax="y: 800,0,0;">
                  This phrase is more casual and playful. It suggests that you are keeping your friends updated on what’s
          ...
          <li class="w-full">
            <img src="../template/assets/images/post/img-2.jpg" alt=""
              class="w-full h-full object-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
            <div class="absolute bottom-0 w-full uk-tr ansition-slide-bottom-small z-10">
              <div class="max-w-xl w-full mx-auto pb-32 px-5 z-30 relative"
                uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
