            ...
            <div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
                    ...
                    <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2.5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex gap-2">
                                    <button type="button"
                                        class="button bg-primary-soft text-primary dark:text-white flex-1">Join</button>
                ...
                <div class="sm:my-6 my-3 flex items-center justify-between">
                    <div>
                        ...
                        <p class="font-normal text-sm text-gray-500 leading-6"> Find a group by browsing top categories.
                        </p>
                    </div>
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="../assets/images/category/Buy-and-sell.jpg" alt=""
                ...
                <div class="sm:my-6 my-3 flex items-center justify-between lg:mt-10">
                    <div>
                        ...
                        <p class="font-normal text-sm text-gray-500 leading-6"> Find a groups You Might Be Interested
                            In. </p>
                    </div>
                    <a href="#" class="text-blue-500 sm:block hidden text-sm"> See all </a>
                </div>
