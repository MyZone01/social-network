...
onMounted(async () => {
  ...
  isRequester.value =
    joinRequests.value?.some((member) => member.User.id === user.id) || false;
});
</script>
  ...
  <NuxtLayout>
    ...
    >
      <div class="max-w-[1065] mx-auto bg-slate-500">
        <div
          class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2 pt-2"
        >
          <div class="relative overflow-hidden w-full lg:h-72 h-32">
            ...
            <div class="absolute bottom-0 right-0 m-a z-20">
              <div class="flex items-center gap-3 px-2">
                <UButton
                  class="button bg-white/10 text-white flex items-center gap-2 back-drop-blur-small"
                >
                  Edit
                </UButton>
              </div>
                ...
                <div>
                  <div class="flex items-center gap-2 mt-1">
                    ...
                    <div>
                      <button
                        type="button"
                        class="rounded-lg bg-slate-100 flex px-2.5 py-2 dark:bg-dark2"
                      >
                        <UIcon
        ...
        <div
          id="group-menus"
          class="uk-switcher flex 2xl:gap-12 gap-10 mt-8 max-lg:flex-col"
        >
          <!-- post tab-->
          <div class="w-full">
            <div
              class="tab bg-white rounded-xl shadow-sm p-4 space-y-4 text-sm font-medium border1 dark:bg-dark2"
            >
          ...
          <div class="w-full">
            ...
            <div class="px-5 flex flex-row justify-between">
              ...
              <div
                uk-toggle="target: #create-event-overlay"
