        ...
        <main id="site__main"
            ...
            <div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
                <div class="page-heading">
                    ...
                    <nav class="nav__underline flex flex-row justify-between">
                        <ul class="group"
                        ...
                        <UButton> <ion-icon :icon="ioniconsAdd"
                                class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>New</UButton>
                    </nav>
                </div>
                <!-- group list tabs -->
