            ...
            <div class="p-4 border-b dark:border-slate-700">
              <div class="flex mt-2 items-center justify-between">
                ...
                <div class="flex items-center gap-2.5">
                  ...
                  >
                    <nav>
                      <a href="#"> <ion-icon class="text-2xl shrink-0 -ml-1" name="checkmark-outline" />
                        Mark all as read </a>
                      <a href="#"> <ion-icon
                        class="text-2xl shrink-0 -ml-1"
                        name="notifications-outline"
                      /> notifications setting </a>
                      <a href="#"> <ion-icon class="text-xl shrink-0 -ml-1" name="volume-mute-outline" />
                        Mute notifications </a>
                    </nav>
                  </div>

                  <button class="">
                    <ion-icon name="checkmark-circle-outline" class="text-2xl flex" />
                  </button>
        ...
        <div class="flex-1">
          ...
          >
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                type="button" class="hover:bg-slate-100 p-1.5 rounded-full"
            ...
            <div class="text-sm font-medium space-y-6">
              ...
              <div class="flex gap-3">
                ...
                <div class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery">
                  ...
                  print on canvas, signed by the photographer. Do you like it? 😊
                </div>
              </div>
              ...
              <div class="flex gap-3">
                ...
                <div class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery">
                  ...
                  lot. But I’m willing to negotiate. What’s your offer? 🤔
                </div>
              </div>
              ...
              <div class="flex gap-3">
                <img src="../assets/images/avatars/avatar-2.jpg" alt="" class="w-9 h-9 rounded-full shadow">
                <div class="px-4 py-2 rounded-[20px] max-w-sm bg-secondery">
                  Fine, fine. You’re hard to please. I’ll
                  take $160, but only because I like you. 😍
                </div>
              </div>
          ...
          >
            ...
            <ul class="text-base font-medium p-3">
              ...
              <li>
                ...
                >
                  <ion-icon
                    name="trash-outline" class="text-2xl"
                  /> Delete Chat
                </button>
              </li>
            </ul>
            ...
            <!-- close button -->
            <button
              type="button" class="absolute top-0 right-0 m-4 p-2 bg-secondery rounded-full"
              uk-toggle="target: .rightt ; cls: hidden"
            >
