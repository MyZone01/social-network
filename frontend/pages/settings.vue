            ...
            <div class="flex md:gap-8 gap-4 items-center md:p-8 p-6 md:pb-4">
              <div class="relative md:w-20 md:h-20 w-12 h-12 shrink-0">
                <label for="file" class="cursor-pointer">
                  <nuxt-image id="img" :src="data.avatar" class="object-cover w-full h-full rounded-full" alt="" />
                ...
                <div>
                  <div class="space-y-6">
                    ...
                    <div class="md:flex items-start gap-10">
                      ...
                      <div class="flex-1 max-md:mt-4">
                        <textarea class="w-full" rows="5" placeholder="Inter your Bio" />
                      </div>
                    </div>
                  ...
                  <div class="flex items-center gap-4 mt-16 lg:pl-[10.5rem]">
                    <!-- <button type="submit" class="button lg:px-6 bg-secondery max-md:flex-1">
                                Cancel</button> -->
                    <button type="submit" class="button lg:px-10 bg-primary text-white max-md:flex-1" @click.prevent="saveChanges()">
                      Save
              ...
              <div>
                <form @submit.prevent="changePassword()">
                  ...
                  <div class="flex items-center justify-center gap-4 mt-16">
                    <!-- <button type="submit" class="button lg:px-6 bg-secondery max-md:flex-1">
                                Cancel</button> -->
                    <button type="submit" class="button lg:px-10 bg-primary text-white max-md:flex-1" @click.prevent="changePassword()">
                      Save
                    </button>
                  </div>
                </form>
                    ...
                    <div class="flex-1 space-y-4 interactive-effect max-md:mt-5">
                      <div>
                        <label class="inline-flex items-center">
                          <input
                            class="rounded" type="checkbox" checked name="checkbox1"
                            value="3"
                          >
                      ...
                      <div>
                        <label class="inline-flex items-center">
                          <input
                            class="rounded" type="checkbox" checked name="checkbox2"
                            value="3"
                          >
                  ...
                  <div class="max-w-lg mx-auto font-normal text-gray-400 text-sm">
                    <div>
                      ...
                      <p class=" mt-3">
                        ...
                        account
                        and content
                        outside of you preferred notivications settings
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <div class="w-full">
                        ...
                        >
                          ...
                          <input type="checkbox"><span class="switch-button !relative" />
                        </label>
                      </div>
