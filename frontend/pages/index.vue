      ...
      <div class="md:max-w-[580px] mx-auto flex-1 xl:space-y-6 space-y-3">
          ...
          <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
            ...
            <div class="-mr-1">
              ...
              <div class="w-[245px]"
                ...
                <nav>
                  <a href="#"> <ion-icon class="text-xl shrink-0" :icon="ioniconsBookmarkOutline"></ion-icon> Add to favorites
                  </a>
                  <a href="#"> <ion-icon class="text-xl shrink-0" :icon="ioniconsNotificationsOffOutline"></ion-icon> Mute
                    Notification </a>
                  <a href="#"> <ion-icon class="text-xl shrink-0" :icon="ioniconsFlagOutline"></ion-icon> Report this post </a>
                  <a href="#"> <ion-icon class="text-xl shrink-0" :icon="ioniconsShareOutline"></ion-icon> Share your profile </a>
                  <hr>
                  <a href="#" class="text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50">
                    <ion-icon class="text-xl shrink-0" :icon="ioniconsStopCircleOutline"></ion-icon> Unfollow </a>
                </nav>
              </div>
            </div>
          </div>
          ...
          <div class="sm:p-4 p-2.5 flex items-center gap-4 text-xs font-semibold">
            <div>
              <div class="flex items-center gap-2.5">
                <button type="button" class="button-icon text-red-500 bg-red-100 dark:bg-slate-700"> <ion-icon
                    class="text-lg" :icon="ioniconsHeart"></ion-icon> </button>
                <a href="#">1,300</a>
              </div>
            ...
            <button type="button" class="button-icon"> <ion-icon class="text-xl" :icon="ioniconsShareOutline"></ion-icon>
            </button>
          </div>
        ...
        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
          ...
          <div class="relative uk-visible-toggle sm:px-4" tabindex="-1" uk-slideshow="animation: push;ratio: 4:3">
            ...
            <a class="nav-prev left-6" href="#" uk-slideshow-item="previous"> <ion-icon :icon="ioniconsChevronBack"
                class="text-2xl"></ion-icon> </a>
            <a class="nav-next right-6" href="#" uk-slideshow-item="next"> <ion-icon :icon="ioniconsChevronForward"
                class="text-2xl"></ion-icon></a>
        ...
        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
          ...
          <!-- post heading -->
          <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
            <a href="timeline.html"> <img src="assets/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full">
            </a>
            <div class="flex-1">
              <a href="timeline.html">
            ...
            <div class="-mr-1">
              <button type="button" class="button__ico w-8 h-8" aria-haspopup="true" aria-expanded="false"> <ion-icon
                  class="text-xl md hydrated" :icon="ioniconsEllipsisHorizontal" role="img"
                  aria-label="ellipsis horizontal"></ion-icon> </button>
              <div class="w-[245px] uk-dropdown"
                uk-dropdown="pos: bottom-right; animation: uk-animation-scale-up uk-transform-origin-top-right; animate-out: true; mode: click">
                <nav>
                  <a href="#"> <ion-icon class="text-xl shrink-0 md hydrated" :icon="ioniconsBookmarkOutline" role="img"
                      aria-label="bookmark outline"></ion-icon> Add to favorites </a>
                  <a href="#"> <ion-icon class="text-xl shrink-0 md hydrated" :icon="ioniconsNotificationsOffOutline" role="img"
                      aria-label="notifications off outline"></ion-icon> Mute Notification
                  </a>
                  <a href="#"> <ion-icon class="text-xl shrink-0 md hydrated" :icon="ioniconsFlagOutline" role="img"
                      aria-label="flag outline"></ion-icon>
                    Report this post </a>
                  <a href="#"> <ion-icon class="text-xl shrink-0 md hydrated" :icon="ioniconsShareOutline" role="img"
                      aria-label="share outline"></ion-icon> Share your profile </a>
                  <hr>
                  <a href="#" class="text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50">
                    <ion-icon class="text-xl shrink-0 md hydrated" :icon="ioniconsStopCircleOutline" role="img"
