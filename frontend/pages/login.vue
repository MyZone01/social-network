  ...
  <div class="sm:flex">
    ...
    >
      ...
      >
        <!-- logo image-->
        <a href="#"> <img
          src="/_nuxt/assets/images/logo.png" class="w-28 absolute top-10 left-10 dark:hidden"
          alt=""
        ></a>
        <a href="#"> <img
          src="/_nuxt/assets/images/logo-light.png"
        ...
        <div>
          ...
          <p class="text-sm text-gray-700 font-normal">
            If you haven’t signed up yet. <router-link to="/register" class="text-blue-700">
              Register here!
            </router-link>
          </p>
        </div>
        ...
        >
          ...
          <UFormGroup label="Email" name="email">
            <div class="mt-2.5">
              <UInput
                id="email" v-model="state.email" name="email" type="email" placeholder="Email"
          ...
          <UFormGroup label="Password" name="password">
            <div class="mt-2.5">
              <UInput
                id="password" v-model="state.password" name="password" type="password" placeholder="***"
                class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"
              />
            </div>
          </UFormGroup>
    ...
    <div class="flex-1 relative bg-primary max-md:hidden">
      <div class="relative w-full h-full" tabindex="-1" uk-slideshow="animation: slide; autoplay: true">
        <ul class="uk-slideshow-items w-full h-full">
          <li class="w-full">
            <img
              src="/_nuxt/assets/images/post/img-3.jpg" alt=""
          ...
          <li class="w-full">
            <img
              src="/_nuxt/assets/images/post/img-2.jpg" alt=""
              class="w-full h-full object-cover uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left"
            >
            <div class="absolute bottom-0 w-full uk-tr ansition-slide-bottom-small z-10">
              <div
