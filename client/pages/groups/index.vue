  ...
  <main id="site__main"
    ...
    <div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto h-full">
      ...
      <div id="group-tabs">
        <nav>
          <ul
            ...
            <li>
              <a href="#" class="inline-block py-3 leading-8 px-3.5">My Groups</a>
            </li>
            <li>
      ...
      <div id="group-tab" class="uk-switcher">
        <div>
          <div v-if="groups.length" class="flex flex-row flex-wrap overflow-scroll gap-2">
            <GroupCard v-bind:key="group.ID" v-for="group in groups" :group="group" :joined="true" />
          </div>
        </div>
